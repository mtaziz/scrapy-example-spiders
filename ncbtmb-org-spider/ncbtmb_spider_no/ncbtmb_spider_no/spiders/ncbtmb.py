...
class NcbtmbSpider(CrawlSpider):
    ...
    # def parse_ncbtmb(self, response):
        ...
        infos = sel.xpath('//tr[contains(@class, "odd board-certified-Yes views-row-first") or contains(@class, "even board-certified-Yes") or contains(@class, "odd board-certified-Yes")]')
        for info in infos:
